...
const Skills = () => {
  ...
  const skillsData = [
  {
    ...
    sections: [
      { subtitle: "Proficient", skills: ["Java", "C", "C++", "Python", "JavaScript", "SQL", "Node.js"] }, // Added Node.js
  ...
  },
  {
    ...
    sections: [
      { subtitle: "Frameworks & Libraries", skills: ["React.js", "React Native", "Bootstrap", "Zustand"]}, // Added Zustand
      { subtitle: "UI/UX & Styling", skills: ["HTML5", "CSS3", "Responsive Design", "Figma"] }, // Added Custom CSS
  ...
  // },
  {
    ...
    sections: [
      ...
      { subtitle: "Cloud Services", skills: ["Cloudinary", "Render"]} // NEW SECTION
    ]
  },
  {
    title: "Security & Authentication",
    sections: [
      { subtitle: "Authentication", skills: ["JWT", "HTTP-only Cookies", "bcrypt"]}, // NEW SECTION
      { subtitle: "Security Practices", skills: ["Secure Session Management", "Password Hashing"]} // NEW SECTION
    ]
  },
  {
    title: "Backend & Systems Programming",
    sections: [
      { subtitle: "Backend Frameworks", skills: ["Express.js", "Node.js", "RESTful API Design"]}, // NEW SECTION
      { subtitle: "Real-time Communication", skills: ["Socket.io", "WebSockets"]}, // NEW SECTION
      ...
      { subtitle: "Databases", skills: ["SQL", "MongoDB", "Mongoose"]} // Added Mongoose
    ]
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { subtitle: "System Design", skills: ["Client-Server Architecture", "Protocol Design", "Real-time Systems"]}, // Added Real-time Systems
